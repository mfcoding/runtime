...
if(des!=NULL){ strcpy(des, src); }else{____MALLOC_Err_msg; return EXIT__FAILURE;}
...
src = (string)realloc((string)src, MAX_MALLOC=____c+1); if(src==NULL){____MALLOC_Err_msg; return EXIT__FAILURE;}
